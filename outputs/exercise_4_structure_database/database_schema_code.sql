...
ALTER TABLE "DimArtist" ADD FOREIGN KEY ("Id") REFERENCES "MappingPdfArtist" ("ArtistKey");

ALTER TABLE "DimPDF" ADD FOREIGN KEY ("Id") REFERENCES "MappingPdfArtist" ("PDFKey");
